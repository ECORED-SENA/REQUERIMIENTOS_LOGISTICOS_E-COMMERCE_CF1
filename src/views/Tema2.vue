...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    figure.mb-5
      img(src='@/assets/curso/infografia-1.svg', alt='Infografía Fundamentos del Servicio de Interpretación')
    ...
    figure.mb-5
      img(src='@/assets/curso/infografia-2.svg', alt='Infografía Plan de Negocios')
